...
<p>Gets the <a href="GraphObject.html">GraphObject</a> that is being rescaled.
...
in RescalingTool, and not during normal operation.</p>
...
<p>This property returns the <a href="GraphObject.html">GraphObject</a> that is the tool handle being dragged by the user.
This will be contained by an <a href="Adornment.html">Adornment</a> whose category is &quot;RescalingTool&quot;.
Its <a href="Adornment.html#adornedObject">Adornment.adornedObject</a> is the same as the <a href="RescalingTool.html#adornedObject">adornedObject</a>.</p>
<div><p>This property is also settable, but should only be set either within an override of <a href="RescalingTool.html#doActivate">doActivate</a>
or prior to calling <a href="RescalingTool.html#doActivate">doActivate</a>.</p>
...
<p>Gets or sets a small GraphObject that is copied as a rescale handle for the selected part.
By default this is a <a href="Shape.html">Shape</a> that is a small blue square.
Setting this property does not raise any events.</p>
<div><p>Here is an example of changing the default handle to be green &quot;X&quot;:</p>
<pre><code class="language-js"><span class="hl-2">  </span><span class="hl-4">tool</span><span class="hl-2">.</span><span class="hl-4">handleArchetype</span><span class="hl-2"> =</span><br/><span class="hl-2">    </span><span class="hl-5">$</span><span class="hl-2">(</span><span class="hl-4">go</span><span class="hl-2">.</span><span class="hl-4">Shape</span><span class="hl-2">, </span><span class="hl-6">&quot;XLine&quot;</span><span class="hl-2">,</span><br/><span class="hl-2">      { </span><span class="hl-4">width:</span><span class="hl-2"> </span><span class="hl-7">8</span><span class="hl-2">, </span><span class="hl-4">height:</span><span class="hl-2"> </span><span class="hl-7">8</span><span class="hl-2">, </span><span class="hl-4">stroke:</span><span class="hl-2"> </span><span class="hl-6">&quot;green&quot;</span><span class="hl-2">, </span><span class="hl-4">fill:</span><span class="hl-2"> </span><span class="hl-6">&quot;transparent&quot;</span><span class="hl-2"> });</span>
</code></pre>
</div></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="rescaleObjectName" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> rescale<wbr/>Object<wbr/>Name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><a href="#rescaleObjectName" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>This property returns the name of the GraphObject that identifies the object to be rescaled by this tool.</p>
<div><p>The default value is the empty string, resulting in the whole Node being rescaled.
This property is used by findRescaleObject when calling <a href="Panel.html#findObject">Panel.findObject</a>.</p>
...
<p>Activating this tool remembers the <a href="RescalingTool.html#handle">handle</a> that was dragged,
the <a href="RescalingTool.html#adornedObject">adornedObject</a> that is being rescaled,
starts a transaction, and captures the mouse.</p>
...
<p>Restore the original <a href="GraphObject.html#scale">GraphObject.scale</a> of the adorned object.</p>
...
<p>Stop the current transaction, forget the <a href="RescalingTool.html#handle">handle</a> and <a href="RescalingTool.html#adornedObject">adornedObject</a>, and release the mouse.</p>
...
<p>Call <a href="RescalingTool.html#scale">scale</a> with a new scale determined by the current mouse point.
This determines the new scale by calling <a href="RescalingTool.html#computeScale">computeScale</a>.</p>
...
<p>Call <a href="RescalingTool.html#scale">scale</a> with a new scale determined by the most recent mouse point,
and commit the transaction.</p>
</div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="findRescaleObject" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> find<wbr/>Rescale<wbr/>Object<a href="#findRescaleObject" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">find<wbr/>Rescale<wbr/>Object<span class="tsd-signature-symbol">(</span>part<span class="tsd-signature-symbol">: </span><a href="Part.html" class="tsd-signature-type" data-tsd-kind="Class">Part</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="GraphObject.html" class="tsd-signature-type" data-tsd-kind="Class">GraphObject</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Return the GraphObject to be rescaled by the user.</p>
...
<p>Set the <a href="GraphObject.html#scale">GraphObject.scale</a> of the <a href="RescalingTool.html#findRescaleObject">findRescaleObject</a>.</p>
</div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>newScale: <span class="tsd-signature-type">number</span></h5><div class="tsd-comment tsd-typography">
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a id="updateAdornments" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagOverride">Override</span>  update<wbr/>Adornments<a href="#updateAdornments" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><li class="tsd-signature tsd-kind-icon">update<wbr/>Adornments<span class="tsd-signature-symbol">(</span>part<span class="tsd-signature-symbol">: </span><a href="Part.html" class="tsd-signature-type" data-tsd-kind="Class">Part</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>part: <a href="Part.html" class="tsd-signature-type" data-tsd-kind="Class">Part</a></h5><div class="tsd-comment tsd-typography">
