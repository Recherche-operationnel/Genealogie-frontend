...
<div><p>Here is an example of changing the default handle to be larger green triangles:</p>
<pre><code class="language-js"><span class="hl-4">myDiagram</span><span class="hl-2">.</span><span class="hl-4">toolManager</span><span class="hl-2">.</span><span class="hl-4">relinkingTool</span><span class="hl-2">.</span><span class="hl-4">toHandleArchetype</span><span class="hl-2"> =</span><br/><span class="hl-2">  </span><span class="hl-5">$</span><span class="hl-2">(</span><span class="hl-4">go</span><span class="hl-2">.</span><span class="hl-4">Shape</span><span class="hl-2">, </span><span class="hl-6">&quot;Triangle&quot;</span><span class="hl-2">,</span><br/><span class="hl-2">    { </span><span class="hl-4">width:</span><span class="hl-2"> </span><span class="hl-7">10</span><span class="hl-2">, </span><span class="hl-4">height:</span><span class="hl-2"> </span><span class="hl-7">10</span><span class="hl-2">, </span><span class="hl-4">fill:</span><span class="hl-2"> </span><span class="hl-6">&quot;limegreen&quot;</span><span class="hl-2">, </span><span class="hl-4">segmentIndex:</span><span class="hl-2"> </span><span class="hl-7">0</span><span class="hl-2"> });</span>
</code></pre>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="RelinkingTool.html#toHandleArchetype">toHandleArchetype</a></p>
...
This will be contained by an <a href="Adornment.html">Adornment</a> whose category is &quot;RelinkFrom&quot; or &quot;RelinkTo&quot;.
Its <a href="Adornment.html#adornedPart">Adornment.adornedPart</a> is the same as the <a href="LinkingBaseTool.html#originalLink">originalLink</a>.</p>
<div><p>This property is also settable, but should only be set either within an override of <a href="RelinkingTool.html#doActivate">doActivate</a>
or prior to calling <a href="RelinkingTool.html#doActivate">doActivate</a>.</p>
</div></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="toHandleArchetype" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> to<wbr/>Handle<wbr/>Archetype<span class="tsd-signature-symbol">: </span><a href="GraphObject.html" class="tsd-signature-type" data-tsd-kind="Class">GraphObject</a><a href="#toHandleArchetype" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets a small GraphObject that is copied as a relinking handle for the selected link path
at the &quot;to&quot; end of the link.
By default this is a <a href="Shape.html">Shape</a> that is a small blue diamond.
Setting this property does not raise any events.</p>
<div><p>Here is an example of changing the default handle to be larger orange triangles:</p>
<pre><code class="language-js"><span class="hl-2">  </span><span class="hl-4">myDiagram</span><span class="hl-2">.</span><span class="hl-4">toolManager</span><span class="hl-2">.</span><span class="hl-4">relinkingTool</span><span class="hl-2">.</span><span class="hl-4">toHandleArchetype</span><span class="hl-2"> =</span><br/><span class="hl-2">  </span><span class="hl-5">$</span><span class="hl-2">(</span><span class="hl-4">go</span><span class="hl-2">.</span><span class="hl-4">Shape</span><span class="hl-2">, </span><span class="hl-6">&quot;Triangle&quot;</span><span class="hl-2">,</span><br/><span class="hl-2">    { </span><span class="hl-4">width:</span><span class="hl-2"> </span><span class="hl-7">10</span><span class="hl-2">, </span><span class="hl-4">height:</span><span class="hl-2"> </span><span class="hl-7">10</span><span class="hl-2">, </span><span class="hl-4">fill:</span><span class="hl-2"> </span><span class="hl-6">&quot;orange&quot;</span><span class="hl-2">, </span><span class="hl-4">segmentIndex:</span><span class="hl-2"> -</span><span class="hl-7">1</span><span class="hl-2"> });</span>
</code></pre>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="RelinkingTool.html#fromHandleArchetype">fromHandleArchetype</a></p>
...
<p>This tool can run when the diagram allows relinking, the model is modifiable,
and there is a relink handle at the mouse-down point.</p>
<div><p>This method may be overridden, but we recommend that you call this base method.</p>
</div></div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4><div></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-protected"><a id="copyLinkProperties" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagProtected">Protected</span> <span class="tsd-flag ts-flagVirtual">Virtual</span>  copy<wbr/>Link<wbr/>Properties<a href="#copyLinkProperties" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-protected"><li class="tsd-signature tsd-kind-icon">copy<wbr/>Link<wbr/>Properties<span class="tsd-signature-symbol">(</span>reallink<span class="tsd-signature-symbol">: </span><a href="Link.html" class="tsd-signature-type" data-tsd-kind="Class">Link</a>, templink<span class="tsd-signature-symbol">: </span><a href="Link.html" class="tsd-signature-type" data-tsd-kind="Class">Link</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Make a temporary link look and act like the real Link being relinked.
By default this method copies many of the routing-oriented properties
from the <a href="LinkingBaseTool.html#originalLink">LinkingBaseTool.originalLink</a> to the <a href="LinkingBaseTool.html#temporaryLink">LinkingBaseTool.temporaryLink</a>.</p>
...
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>reallink: <a href="Link.html" class="tsd-signature-type" data-tsd-kind="Class">Link</a></h5></li><li><h5>templink: <a href="Link.html" class="tsd-signature-type" data-tsd-kind="Class">Link</a></h5></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a id="doActivate" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagOverride">Override</span>  do<wbr/>Activate<a href="#doActivate" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><li class="tsd-signature tsd-kind-icon">do<wbr/>Activate<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Start the relinking operation.</p>
<div><p>Find the relink handle by calling <a href="Tool.html#findToolHandleAt">Tool.findToolHandleAt</a>
looking for either the &quot;RelinkFrom&quot; adornment or the &quot;RelinkTo&quot; adornment,
saving the result in <a href="RelinkingTool.html#handle">handle</a>.</p>
<p>Normally when this method is called the value of <a href="LinkingBaseTool.html#originalLink">LinkingBaseTool.originalLink</a> and <a href="RelinkingTool.html#handle">handle</a> will be null,
resulting in a call to <a href="Tool.html#findToolHandleAt">Tool.findToolHandleAt</a> to find a &quot;RelinkFrom&quot; or &quot;RelinkTo&quot; tool handle,
which is then remembered as the value of <a href="RelinkingTool.html#handle">handle</a>.
If when this method is called the value of <a href="RelinkingTool.html#handle">handle</a> is already set,
...
Finding a handle is not necessary if <a href="LinkingBaseTool.html#originalLink">LinkingBaseTool.originalLink</a> and
<a href="LinkingBaseTool.html#isForwards">isForwards</a> have been set before calling this method.</p>
<p>This starts a transaction, captures the mouse, and sets the cursor.</p>
<p>If <a href="LinkingBaseTool.html#originalLink">LinkingBaseTool.originalLink</a> or <a href="RelinkingTool.html#handle">handle</a> was not set beforehand,
the value of <a href="LinkingBaseTool.html#isForwards">isForwards</a> is set depending on the category of the relink handle found.
The <a href="LinkingBaseTool.html#originalLink">LinkingBaseTool.originalLink</a> property and various
&quot;Original...&quot; port and node properties are set too.
The temporary nodes and temporary link are also initialized.</p>
...
<p>A mouse-up ends the relinking operation; if there is a valid <a href="LinkingBaseTool.html#targetPort">targetPort</a> nearby,
this modifies the old link to connect with the target port.</p>
<div><p>A successful relinking calls <a href="RelinkingTool.html#reconnectLink">reconnectLink</a> to actually change the link.
The &quot;LinkRelinked&quot; <a href="DiagramEvent.html">DiagramEvent</a> is raised with the link as the <a href="DiagramEvent.html#subject">DiagramEvent.subject</a>
and with the now-disconnected original port as the <a href="DiagramEvent.html#parameter">DiagramEvent.parameter</a>.
If the link was not reconnected, this calls <a href="RelinkingTool.html#doNoRelink">doNoRelink</a>.
In any case this stops the tool.</p>
<p>A failure to find a valid target port results in no changes and no DiagramEvent.</p>
<p>This method may be overridden, but we recommend that you call this base method.
You might find it easier to override <a href="RelinkingTool.html#reconnectLink">reconnectLink</a>.
It is actually most common to implement a &quot;LinkRelinked&quot; <a href="DiagramEvent.html">DiagramEvent</a> listener on the <a href="Diagram.html">Diagram</a>.</p>
</div></div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="doNoRelink" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagVirtual">Virtual</span>  do<wbr/>No<wbr/>Relink<a href="#doNoRelink" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">do<wbr/>No<wbr/>Relink<span class="tsd-signature-symbol">(</span>existinglink<span class="tsd-signature-symbol">: </span><a href="Link.html" class="tsd-signature-type" data-tsd-kind="Class">Link</a>, toend<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>This method is called upon a mouse up when <a href="RelinkingTool.html#reconnectLink">reconnectLink</a> is not called.</p>
...
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>existinglink: <a href="Link.html" class="tsd-signature-type" data-tsd-kind="Class">Link</a></h5></li><li><h5>toend: <span class="tsd-signature-type">boolean</span></h5><div class="tsd-comment tsd-typography">
<p>If true, the user was trying to modify the link&#39;s &quot;to&quot; node and port.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="reconnectLink" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagVirtual">Virtual</span>  reconnect<wbr/>Link<a href="#reconnectLink" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">reconnect<wbr/>Link<span class="tsd-signature-symbol">(</span>existinglink<span class="tsd-signature-symbol">: </span><a href="Link.html" class="tsd-signature-type" data-tsd-kind="Class">Link</a>, newnode<span class="tsd-signature-symbol">: </span><a href="Node.html" class="tsd-signature-type" data-tsd-kind="Class">Node</a>, newport<span class="tsd-signature-symbol">: </span><a href="GraphObject.html" class="tsd-signature-type" data-tsd-kind="Class">GraphObject</a>, toend<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Modify an existing <a href="Link.html">Link</a> to connect to a new node and port.</p>
<div><p>This method may be overridden, but we recommend that you call this base method.
Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="RelinkingTool.html#doNoRelink">doNoRelink</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>existinglink: <a href="Link.html" class="tsd-signature-type" data-tsd-kind="Class">Link</a></h5></li><li><h5>newnode: <a href="Node.html" class="tsd-signature-type" data-tsd-kind="Class">Node</a></h5><div class="tsd-comment tsd-typography">
<p>the <a href="Node.html">Node</a> to connect to or from.</p>
</div></li><li><h5>newport: <a href="GraphObject.html" class="tsd-signature-type" data-tsd-kind="Class">GraphObject</a></h5><div class="tsd-comment tsd-typography">
<p>the <a href="GraphObject.html">GraphObject</a> port to connect to or from.</p>
</div></li><li><h5>toend: <span class="tsd-signature-type">boolean</span></h5><div class="tsd-comment tsd-typography">
<p>If true, this modifies the link&#39;s &quot;to&quot; node and port; otherwise it modifies the &quot;from&quot; node and port.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4><div><p>true if successful.</p>
...
<p>Show an <a href="Adornment.html">Adornment</a> for each end of the <a href="Link.html">Link</a> that the user may reconnect.
The Adornment may have a copy of <a href="RelinkingTool.html#fromHandleArchetype">fromHandleArchetype</a> and/or <a href="RelinkingTool.html#toHandleArchetype">toHandleArchetype</a>.</p>
<div><p>This method may be overridden.</p>
...
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class"><a href="RelinkingTool.html" class="tsd-kind-icon">Relinking<wbr/>Tool</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite"><a href="RelinkingTool.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="RelinkingTool.html#fromHandleArchetype" class="tsd-kind-icon">from<wbr/>Handle<wbr/>Archetype</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="RelinkingTool.html#handle" class="tsd-kind-icon">handle</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="RelinkingTool.html#toHandleArchetype" class="tsd-kind-icon">to<wbr/>Handle<wbr/>Archetype</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RelinkingTool.html#canStart" class="tsd-kind-icon">can<wbr/>Start</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-protected"><a href="RelinkingTool.html#copyLinkProperties" class="tsd-kind-icon">copy<wbr/>Link<wbr/>Properties</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RelinkingTool.html#doActivate" class="tsd-kind-icon">do<wbr/>Activate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RelinkingTool.html#doDeactivate" class="tsd-kind-icon">do<wbr/>Deactivate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RelinkingTool.html#doMouseUp" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Up</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="RelinkingTool.html#doNoRelink" class="tsd-kind-icon">do<wbr/>No<wbr/>Relink</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="RelinkingTool.html#reconnectLink" class="tsd-kind-icon">reconnect<wbr/>Link</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RelinkingTool.html#updateAdornments" class="tsd-kind-icon">update<wbr/>Adornments</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
