...
into an ellipse.</p>
<div><p>The aspect ratio of this ellipse is determined by either
<a href="PackedLayout.html#aspectRatio">aspectRatio</a> or <a href="PackedLayout.html#size">size</a>.</p>
</div></div></section><section class="tsd-panel tsd-member tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a id="static-ExpandToFit" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagReadonly">Readonly</span>  Expand<wbr/>To<wbr/>Fit<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">12</span><a href="#static-ExpandToFit" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><div class="tsd-comment tsd-typography">
<p>Nodes will be either compressed or spaced evenly to fit the given
<a href="PackedLayout.html#size">size</a>; this value is used for <a href="PackedLayout.html#packMode">packMode</a>.</p>
<div><p>The <a href="PackedLayout.html#spacing">spacing</a> property will not be respected in this mode, and
will not do anything if set.</p>
</div></div></section><section class="tsd-panel tsd-member tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a id="static-Fit" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagReadonly">Readonly</span>  Fit<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">11</span><a href="#static-Fit" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><div class="tsd-comment tsd-typography">
<p>Nodes will be compressed if necessary (using negative spacing) to fit the given
<a href="PackedLayout.html#size">size</a>. However, if the <a href="PackedLayout.html#size">size</a> is bigger
than the packed shape (with 0 spacing), it will not expand to fit it. This value
is used for <a href="PackedLayout.html#packMode">packMode</a>.</p>
<div><p>The <a href="PackedLayout.html#spacing">spacing</a> property will be respected in this mode, but only
if it does not cause the layout to grow larger than the <a href="PackedLayout.html#size">size</a>.</p>
</div></div></section><section class="tsd-panel tsd-member tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a id="static-MaxSide" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagReadonly">Readonly</span>  Max<wbr/>Side<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">21</span><a href="#static-MaxSide" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><div class="tsd-comment tsd-typography">
<p>Nodes will be sorted by their maximum side length before packing; this value is
used for <a href="PackedLayout.html#sortMode">sortMode</a>.</p>
</div></section><section class="tsd-panel tsd-member tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a id="static-None" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagReadonly">Readonly</span>  None<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">20</span><a href="#static-None" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><div class="tsd-comment tsd-typography">
<p>Nodes will not be sorted before packing; this value is used for <a href="PackedLayout.html#sortMode">sortMode</a>.</p>
</div></section><section class="tsd-panel tsd-member tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a id="static-Rectangular" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagReadonly">Readonly</span>  Rectangular<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">1</span><a href="#static-Rectangular" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><div class="tsd-comment tsd-typography">
<p>Causes nodes to be packed into a rectangle; this value is used for
<a href="PackedLayout.html#packShape">packShape</a>.</p>
<div><p>The aspect ratio of this rectangle is determined by either
<a href="PackedLayout.html#aspectRatio">aspectRatio</a> or <a href="PackedLayout.html#size">size</a>.</p>
</div></div></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class tsd-is-extension"><a href="PackedLayout.html" class="tsd-kind-icon">Packed<wbr/>Layout</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-inherited"><a href="PackedLayout.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="PackedLayout.html#actualBounds" class="tsd-kind-icon">actual<wbr/>Bounds</a></li><li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="PackedLayout.html#actualSpacing" class="tsd-kind-icon">actual<wbr/>Spacing</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#arrangesToOrigin" class="tsd-kind-icon">arranges<wbr/>To<wbr/>Origin</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#aspectRatio" class="tsd-kind-icon">aspect<wbr/>Ratio</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#comparer" class="tsd-kind-icon">comparer</a></li><li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="PackedLayout.html#enclosingCircle" class="tsd-kind-icon">enclosing<wbr/>Circle</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#hasCircularNodes" class="tsd-kind-icon">has<wbr/>Circular<wbr/>Nodes</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#packMode" class="tsd-kind-icon">pack<wbr/>Mode</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#packShape" class="tsd-kind-icon">pack<wbr/>Shape</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#size" class="tsd-kind-icon">size</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#sortMode" class="tsd-kind-icon">sort<wbr/>Mode</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#sortOrder" class="tsd-kind-icon">sort<wbr/>Order</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PackedLayout.html#spacing" class="tsd-kind-icon">spacing</a></li><li class="tsd-kind-property tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-Spiral" class="tsd-kind-icon">Spiral</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PackedLayout.html#commitLayout" class="tsd-kind-icon">commit<wbr/>Layout</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PackedLayout.html#doLayout" class="tsd-kind-icon">do<wbr/>Layout</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-Area" class="tsd-kind-icon">Area</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-Ascending" class="tsd-kind-icon">Ascending</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-AspectOnly" class="tsd-kind-icon">Aspect<wbr/>Only</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-Descending" class="tsd-kind-icon">Descending</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-Elliptical" class="tsd-kind-icon">Elliptical</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-ExpandToFit" class="tsd-kind-icon">Expand<wbr/>To<wbr/>Fit</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-Fit" class="tsd-kind-icon">Fit</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-MaxSide" class="tsd-kind-icon">Max<wbr/>Side</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-None" class="tsd-kind-icon">None</a></li><li class="tsd-kind-constant tsd-parent-kind-class tsd-is-static"><a href="PackedLayout.html#static-Rectangular" class="tsd-kind-icon">Rectangular</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
