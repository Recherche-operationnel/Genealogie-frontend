...
<p>Gets or sets whether this tool only places the shape&#39;s corners on the Diagram&#39;s visible grid.
The default value is false</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="isOrthoOnly" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> is<wbr/>Ortho<wbr/>Only<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><a href="#isOrthoOnly" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets whether this tool draws shapes with only orthogonal segments, or segments in any direction.
The default value is false -- draw segments in any direction. This does not restrict the closing segment, which may not be orthogonal.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="isPolygon" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> is<wbr/>Polygon<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><a href="#isPolygon" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets whether this tools draws a filled polygon or an unfilled open polyline.</p>
<div><p>The default value is true.</p>
</div></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="temporaryShape" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> temporary<wbr/>Shape<span class="tsd-signature-symbol">: </span><a href="Shape.html" class="tsd-signature-type" data-tsd-kind="Class">Shape</a><a href="#temporaryShape" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the Shape that is used to hold the line as it is being drawn.</p>
<div><p>The default value is a simple Shape drawing an unfilled open thin black line.</p>
...
<p>Don&#39;t start this tool in a mode-less fashion when the user&#39;s mouse-down is on an existing Part.
When this tool is a mouse-down tool, it requires using the left mouse button in the background of a modifiable Diagram.
Modal uses of this tool will not call this canStart predicate.</p>
...
<p>Start a transaction, capture the mouse, use a &quot;crosshair&quot; cursor,
and start accumulating points in the geometry of the <a href="PolygonDrawingTool.html#temporaryShape">temporaryShape</a>.</p>
...
<p>Typing the &quot;ENTER&quot; key accepts the current geometry (excluding the current mouse point)
and creates a new part in the model by calling <a href="PolygonDrawingTool.html#finishShape">finishShape</a>.</p>
<div><p>Typing the &quot;Z&quot; key causes the previous point to be discarded.</p>
<p>Typing the &quot;ESCAPE&quot; key causes the temporary Shape and its geometry to be discarded and this tool to be stopped.</p>
...
<p>Add another point to the geometry of the <a href="PolygonDrawingTool.html#temporaryShape">temporaryShape</a>.</p>
...
<p>Move the last point of the <a href="PolygonDrawingTool.html#temporaryShape">temporaryShape</a>&#39;s geometry to follow the mouse point.</p>
...
<p>Do not stop this tool, but continue to accumulate Points via mouse-down events.</p>
...
<p>Start a transaction, capture the mouse, use a &quot;crosshair&quot; cursor,
and start accumulating points in the geometry of the <a href="PolygonDrawingTool.html#temporaryShape">temporaryShape</a>.</p>
</div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a id="doStop" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagOverride">Override</span>  do<wbr/>Stop<a href="#doStop" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><li class="tsd-signature tsd-kind-icon">do<wbr/>Stop<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Stop the transaction and clean up.</p>
</div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="finishShape" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> finish<wbr/>Shape<a href="#finishShape" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">finish<wbr/>Shape<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Add a new node data JavaScript object to the model and initialize the Part&#39;s
position and its Shape&#39;s geometry by copying the <a href="PolygonDrawingTool.html#temporaryShape">temporaryShape</a>&#39;s <a href="Shape.html#geometry">Shape.geometry</a>.</p>
...
<p>Undo: remove the last point and continue the drawing of new points.</p>
</div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class tsd-is-extension"><a href="PolygonDrawingTool.html" class="tsd-kind-icon">Polygon<wbr/>Drawing<wbr/>Tool</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PolygonDrawingTool.html#archetypePartData" class="tsd-kind-icon">archetype<wbr/>Part<wbr/>Data</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PolygonDrawingTool.html#hasArcs" class="tsd-kind-icon">has<wbr/>Arcs</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PolygonDrawingTool.html#isGridSnapEnabled" class="tsd-kind-icon">is<wbr/>Grid<wbr/>Snap<wbr/>Enabled</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PolygonDrawingTool.html#isOrthoOnly" class="tsd-kind-icon">is<wbr/>Ortho<wbr/>Only</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PolygonDrawingTool.html#isPolygon" class="tsd-kind-icon">is<wbr/>Polygon</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="PolygonDrawingTool.html#temporaryShape" class="tsd-kind-icon">temporary<wbr/>Shape</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#canStart" class="tsd-kind-icon">can<wbr/>Start</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#doActivate" class="tsd-kind-icon">do<wbr/>Activate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#doKeyDown" class="tsd-kind-icon">do<wbr/>Key<wbr/>Down</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#doMouseDown" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Down</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#doMouseMove" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Move</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#doMouseUp" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Up</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#doStart" class="tsd-kind-icon">do<wbr/>Start</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PolygonDrawingTool.html#doStop" class="tsd-kind-icon">do<wbr/>Stop</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="PolygonDrawingTool.html#finishShape" class="tsd-kind-icon">finish<wbr/>Shape</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="PolygonDrawingTool.html#undo" class="tsd-kind-icon">undo</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
