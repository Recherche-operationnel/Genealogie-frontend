...
<p>This tool can run when the diagram allows scrolling and
the mouse has been dragged with the left button far enough away
from the mouse-down point to avoid being a click.</p>
...
<p>Capture the mouse, change the diagram cursor to &quot;move&quot;, and remember the <a href="Diagram.html#position">Diagram.position</a>.</p>
...
<p>Restore the <a href="Diagram.html#position">Diagram.position</a> to what it was when this tool activated.</p>
...
<p>Release the mouse and restore the default diagram cursor.</p>
...
<p>Modify the <a href="Diagram.html#position">Diagram.position</a> according to how much the mouse has moved.</p>
