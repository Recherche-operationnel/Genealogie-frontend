...
<div><p>Each link data object is assumed to have two values, one referring to the node that the
...
</div></li><li><h5><span class="tsd-flag ts-flagOptional">Optional</span> linkdataarray: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">[]</span></h5><div class="tsd-comment tsd-typography">
<p>an optional Array containing JavaScript objects to be represented by Links.</p>
</div></li><li><h5><span class="tsd-flag ts-flagOptional">Optional</span> init: <span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><a href="GraphLinksModel.html" class="tsd-signature-type" data-tsd-kind="Class">GraphLinksModel</a><span class="tsd-signature-symbol">&gt;</span></h5><div class="tsd-comment tsd-typography">
<p>optional initialization properties.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="GraphLinksModel.html" class="tsd-signature-type" data-tsd-kind="Class">GraphLinksModel</a></h4></li><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>This constructs an empty GraphLinksModel unless one provides arguments as the initial data array values
for the <a href="Model.html#nodeDataArray">Model.nodeDataArray</a> and <a href="GraphLinksModel.html#linkDataArray">GraphLinksModel.linkDataArray</a> properties.</p>
</div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5><span class="tsd-flag ts-flagOptional">Optional</span> init: <span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><a href="GraphLinksModel.html" class="tsd-signature-type" data-tsd-kind="Class">GraphLinksModel</a><span class="tsd-signature-symbol">&gt;</span></h5><div class="tsd-comment tsd-typography">
<p>optional initialization properties.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="GraphLinksModel.html" class="tsd-signature-type" data-tsd-kind="Class">GraphLinksModel</a></h4></li></ul></section></section><section class="tsd-panel-group tsd-member-group "><h2>Properties</h2><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="archetypeNodeData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> archetype<wbr/>Node<wbr/>Data<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><a href="#archetypeNodeData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<div><p>The default value is null -- node data is not automatically copied and added to the model
...
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#getCategoryForLinkData">getCategoryForLinkData</a>, <a href="GraphLinksModel.html#setCategoryForLinkData">setCategoryForLinkData</a></p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="linkDataArray" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> link<wbr/>Data<wbr/>Array<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">[]</span><a href="#linkDataArray" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
and if you want this property to be a function, you will need to assign this property to your desired function
immediately after creating the model, including when it is created by <a href="Model.html#static-fromJson">Model.fromJson</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#getFromPortIdForLinkData">getFromPortIdForLinkData</a>, <a href="GraphLinksModel.html#setFromPortIdForLinkData">setFromPortIdForLinkData</a></p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="linkKeyProperty" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> link<wbr/>Key<wbr/>Property<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, b<span class="tsd-signature-symbol">?: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><a href="#linkKeyProperty" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<div><p>When this property has a value of an empty string (the default value),
...
and if you want this property to be a function, you will need to assign this property to your desired function
immediately after creating the model, including when it is created by <a href="Model.html#static-fromJson">Model.fromJson</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#getKeyForLinkData">getKeyForLinkData</a></p>
</dd><dt class="">since</dt><dd><p>1.6</p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="linkLabelKeysProperty" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> link<wbr/>Label<wbr/>Keys<wbr/>Property<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, b<span class="tsd-signature-symbol">?: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><a href="#linkLabelKeysProperty" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the name of the data property that returns
...
and if you want this property to be a function, you will need to assign this property to your desired function
immediately after creating the model, including when it is created by <a href="Model.html#static-fromJson">Model.fromJson</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#getLabelKeysForLinkData">getLabelKeysForLinkData</a>, <a href="GraphLinksModel.html#setLabelKeysForLinkData">setLabelKeysForLinkData</a></p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="linkToKeyProperty" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> link<wbr/>To<wbr/>Key<wbr/>Property<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, b<span class="tsd-signature-symbol">?: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><a href="#linkToKeyProperty" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the name of the data property that returns
...
and if you want this property to be a function, you will need to assign this property to your desired function
immediately after creating the model, including when it is created by <a href="Model.html#static-fromJson">Model.fromJson</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#getToKeyForLinkData">getToKeyForLinkData</a>, <a href="GraphLinksModel.html#setToKeyForLinkData">setToKeyForLinkData</a></p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="linkToPortIdProperty" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> link<wbr/>To<wbr/>Port<wbr/>Id<wbr/>Property<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, b<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><a href="#linkToPortIdProperty" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the name of the data property that returns
...
and if you want this property to be a function, you will need to assign this property to your desired function
immediately after creating the model, including when it is created by <a href="Model.html#static-fromJson">Model.fromJson</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#getToPortIdForLinkData">getToPortIdForLinkData</a>, <a href="GraphLinksModel.html#setToPortIdForLinkData">setToPortIdForLinkData</a></p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="makeUniqueLinkKeyFunction" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> make<wbr/>Unique<wbr/>Link<wbr/>Key<wbr/>Function<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="GraphLinksModel.html" class="tsd-signature-type" data-tsd-kind="Class">GraphLinksModel</a>, b<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><a href="#makeUniqueLinkKeyFunction" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<div><p>The value may be null in order to cause <a href="GraphLinksModel.html#makeLinkDataKeyUnique">makeLinkDataKeyUnique</a> behave in the standard manner.
...
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="nodeGroupKeyProperty" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> node<wbr/>Group<wbr/>Key<wbr/>Property<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, b<span class="tsd-signature-symbol">?: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><a href="#nodeGroupKeyProperty" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
and if you want this property to be a function, you will need to assign this property to your desired function
immediately after creating the model, including when it is created by <a href="Model.html#static-fromJson">Model.fromJson</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#getGroupKeyForNodeData">getGroupKeyForNodeData</a>, <a href="GraphLinksModel.html#setGroupKeyForNodeData">setGroupKeyForNodeData</a></p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="nodeIsGroupProperty" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> node<wbr/>Is<wbr/>Group<wbr/>Property<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, b<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><a href="#nodeIsGroupProperty" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
and if you want this property to be a function, you will need to assign this property to your desired function
immediately after creating the model, including when it is created by <a href="Model.html#static-fromJson">Model.fromJson</a>.</p>
</div></div></li></ul></section></section><section class="tsd-panel-group tsd-member-group "><h2>Methods</h2><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="addLabelKeyForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> add<wbr/>Label<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<a href="#addLabelKeyForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">add<wbr/>Label<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, key<span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Adds a node key value that identifies a node data acting as a new label node on the given link data.</p>
<div><p>This method only works if <a href="GraphLinksModel.html#linkLabelKeysProperty">linkLabelKeysProperty</a> has been set to something other than an empty string.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#removeLabelKeyForLinkData">removeLabelKeyForLinkData</a>, <a href="GraphLinksModel.html#setLabelKeysForLinkData">setLabelKeysForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li><li><h5>key: <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h5><div class="tsd-comment tsd-typography">
<p>a number or string that is the key of the new label node.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="addLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> add<wbr/>Link<wbr/>Data<a href="#addLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">add<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<div><p>Presumably the link data object will already have its &quot;from&quot; and &quot;to&quot; node key references set,
...
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#addLinkData">addLinkData</a>, <a href="GraphLinksModel.html#removeLinkData">removeLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="copyLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> copy<wbr/>Link<wbr/>Data<a href="#copyLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">copy<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<div><p>This does not modify the model -- the returned data object is not added to this model.
...
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="findLinkDataForKey" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> find<wbr/>Link<wbr/>Data<wbr/>For<wbr/>Key<a href="#findLinkDataForKey" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">find<wbr/>Link<wbr/>Data<wbr/>For<wbr/>Key<span class="tsd-signature-symbol">(</span>key<span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Given a number or string, find the link data object in this model
that uses the given value as its unique key.</p>
<div><p>Unless <a href="GraphLinksModel.html#linkKeyProperty">linkKeyProperty</a> is set to a non-empty string, this model
will not automatically assign unique key values for link data objects,
and thus this method will always return null.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#containsLinkData">containsLinkData</a>, <a href="GraphLinksModel.html#getKeyForLinkData">getKeyForLinkData</a></p>
</dd><dt class="">since</dt><dd><p>1.6</p>
...
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="getCategoryForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> get<wbr/>Category<wbr/>For<wbr/>Link<wbr/>Data<a href="#getCategoryForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">get<wbr/>Category<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkCategoryProperty">linkCategoryProperty</a>, <a href="GraphLinksModel.html#setCategoryForLinkData">setCategoryForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="getFromKeyForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> get<wbr/>From<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<a href="#getFromKeyForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">get<wbr/>From<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>From a link data retrieve a value uniquely identifying the node data
from which this link is connected.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkFromKeyProperty">linkFromKeyProperty</a>, <a href="GraphLinksModel.html#setFromKeyForLinkData">setFromKeyForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h4><div><p>This may return undefined if
the link is not coming from any node.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="getFromPortIdForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> get<wbr/>From<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data<a href="#getFromPortIdForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">get<wbr/>From<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>From a link data retrieve a value identifying the port object of the node
from which this link is connected.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkFromPortIdProperty">linkFromPortIdProperty</a>, <a href="GraphLinksModel.html#setFromPortIdForLinkData">setFromPortIdForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4><div><p>This may return the empty string if
there is no particular port parameter information.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="getGroupKeyForNodeData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> get<wbr/>Group<wbr/>Key<wbr/>For<wbr/>Node<wbr/>Data<a href="#getGroupKeyForNodeData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">get<wbr/>Group<wbr/>Key<wbr/>For<wbr/>Node<wbr/>Data<span class="tsd-signature-symbol">(</span>nodedata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>If there is a container group for the given node data, return the group&#39;s key.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#nodeGroupKeyProperty">nodeGroupKeyProperty</a>, <a href="GraphLinksModel.html#setGroupKeyForNodeData">setGroupKeyForNodeData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>nodedata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a node, group, or non-link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h4><div><p>This returns undefined if there is no containing group data.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="getKeyForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> get<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<a href="#getKeyForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">get<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<div><p>It is possible to change the key for a link data object by calling <a href="GraphLinksModel.html#setKeyForLinkData">setKeyForLinkData</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkKeyProperty">linkKeyProperty</a>, <a href="GraphLinksModel.html#setKeyForLinkData">setKeyForLinkData</a>, <a href="GraphLinksModel.html#findLinkDataForKey">findLinkDataForKey</a></p>
</dd><dt class="">since</dt><dd><p>1.6</p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="getLabelKeysForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> get<wbr/>Label<wbr/>Keys<wbr/>For<wbr/>Link<wbr/>Data<a href="#getLabelKeysForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">get<wbr/>Label<wbr/>Keys<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">[]</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets an Array of node key values that identify node data acting as labels on the given link data.</p>
<div><p>This method only works if <a href="GraphLinksModel.html#linkLabelKeysProperty">linkLabelKeysProperty</a> has been set to something other than an empty string.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkLabelKeysProperty">linkLabelKeysProperty</a>, <a href="GraphLinksModel.html#setLabelKeysForLinkData">setLabelKeysForLinkData</a>, <a href="GraphLinksModel.html#addLabelKeyForLinkData">addLabelKeyForLinkData</a>, <a href="GraphLinksModel.html#removeLabelKeyForLinkData">removeLabelKeyForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">[]</span></h4><div><p>an Array of node keys; an empty Array if the property was not present.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="getToKeyForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> get<wbr/>To<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<a href="#getToKeyForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">get<wbr/>To<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>From a link data retrieve a value uniquely identifying the node data
to which this link is connected.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkToKeyProperty">linkToKeyProperty</a>, <a href="GraphLinksModel.html#setToKeyForLinkData">setToKeyForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h4><div><p>This may return undefined if
the link is not going to any node.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="getToPortIdForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> get<wbr/>To<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data<a href="#getToPortIdForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">get<wbr/>To<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>From a link data retrieve a value identifying the port object of the node
to which this link is connected.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkToPortIdProperty">linkToPortIdProperty</a>, <a href="GraphLinksModel.html#setToPortIdForLinkData">setToPortIdForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4><div><p>This may return the empty string if
there is no particular port parameter information.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="isGroupForNodeData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> is<wbr/>Group<wbr/>For<wbr/>Node<wbr/>Data<a href="#isGroupForNodeData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">is<wbr/>Group<wbr/>For<wbr/>Node<wbr/>Data<span class="tsd-signature-symbol">(</span>nodedata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>See if the given node data should be represented as a group or as a simple node.</p>
<div><p>This value must not change as long as the node data is part of the model.
At the current time there is no <code>setIsGroupForNodeData</code> method.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#nodeIsGroupProperty">nodeIsGroupProperty</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>nodedata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a node, group, or non-link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="makeLinkDataKeyUnique" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> make<wbr/>Link<wbr/>Data<wbr/>Key<wbr/>Unique<a href="#makeLinkDataKeyUnique" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">make<wbr/>Link<wbr/>Data<wbr/>Key<wbr/>Unique<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<p>a JavaScript object represented by a link</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="mergeLinkDataArray" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> merge<wbr/>Link<wbr/>Data<wbr/>Array<a href="#mergeLinkDataArray" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">merge<wbr/>Link<wbr/>Data<wbr/>Array<span class="tsd-signature-symbol">(</span>arr<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Take an Array of link data objects and update <a href="GraphLinksModel.html#linkDataArray">linkDataArray</a> without replacing
the Array and without replacing any existing link data objects that are identified by key.
This depends on <a href="GraphLinksModel.html#linkKeyProperty">linkKeyProperty</a> being a non-empty string.</p>
<div><p>For link data objects that have the same key value, this makes calls to <a href="GraphLinksModel.html#setDataProperty">setDataProperty</a>
to update the existing link data object.
For new keys, this calls <a href="Model.html#cloneDeep">cloneDeep</a> to copy the data and then <a href="GraphLinksModel.html#addLinkData">addLinkData</a> to add a new link to the model.
For existing links that have keys that are not present in the given Array,
this calls <a href="GraphLinksModel.html#removeLinkData">removeLinkData</a> to remove the existing link from the model.</p>
...
if a link data object needs to be updated.</p>
<p>This method does not conduct a transaction.</p>
</div><dl class="tsd-comment-tags"><dt class="">since</dt><dd><p>2.1</p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>arr: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">[]</span></h5></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="removeLabelKeyForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> remove<wbr/>Label<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<a href="#removeLabelKeyForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">remove<wbr/>Label<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, key<span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Removes a node key value that identifies a node data acting as a former label node on the given link data.</p>
<div><p>Removing a reference to a node data from the collection of link label keys
...
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#addLabelKeyForLinkData">addLabelKeyForLinkData</a>, <a href="GraphLinksModel.html#setLabelKeysForLinkData">setLabelKeysForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li><li><h5>key: <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h5><div class="tsd-comment tsd-typography">
<p>a number or string that is the key of the label node being removed from the link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="removeLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> remove<wbr/>Link<wbr/>Data<a href="#removeLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">remove<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<p>a JavaScript object represented by a link.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="removeLinkDataCollection" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> remove<wbr/>Link<wbr/>Data<wbr/>Collection<a href="#removeLinkDataCollection" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">remove<wbr/>Link<wbr/>Data<wbr/>Collection<span class="tsd-signature-symbol">(</span>coll<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> | </span><a href="Iterable.html" class="tsd-signature-type" data-tsd-kind="Interface">Iterable</a><span class="tsd-signature-symbol">&lt;</span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="setCategoryForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> set<wbr/>Category<wbr/>For<wbr/>Link<wbr/>Data<a href="#setCategoryForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">set<wbr/>Category<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, cat<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Change the category of a given link data, a string naming the link template
that the <a href="Diagram.html">Diagram</a> should use to represent the link data.</p>
<div><p>Changing the link template for a link data will cause the existing <a href="Link.html">Link</a>
...
<div><p>This gets the old value of the property; if the value is the same as the new value, no side-effects occur.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="Model.html#setDataProperty">Model.setDataProperty</a></p>
...
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="setFromKeyForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> set<wbr/>From<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<a href="#setFromKeyForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">set<wbr/>From<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, key<span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Change the node key that the given link data references as the
source of the link.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkFromKeyProperty">linkFromKeyProperty</a>, <a href="GraphLinksModel.html#getFromKeyForLinkData">getFromKeyForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li><li><h5>key: <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h5><div class="tsd-comment tsd-typography">
<p>This may be undefined if
the link should no longer come from any node.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="setFromPortIdForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> set<wbr/>From<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data<a href="#setFromPortIdForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">set<wbr/>From<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, portname<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Change the information that the given link data uses to identify the
particular &quot;port&quot; that the link is coming from.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkFromPortIdProperty">linkFromPortIdProperty</a>, <a href="GraphLinksModel.html#getFromPortIdForLinkData">getFromPortIdForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li><li><h5>portname: <span class="tsd-signature-type">string</span></h5><div class="tsd-comment tsd-typography">
<p>This may be the empty string if
the link should no longer be associated with any particular &quot;port&quot;.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="setGroupKeyForNodeData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> set<wbr/>Group<wbr/>Key<wbr/>For<wbr/>Node<wbr/>Data<a href="#setGroupKeyForNodeData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">set<wbr/>Group<wbr/>Key<wbr/>For<wbr/>Node<wbr/>Data<span class="tsd-signature-symbol">(</span>nodedata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, key<span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Change the container group for the given node data, given a key for the new group.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#nodeGroupKeyProperty">nodeGroupKeyProperty</a>, <a href="GraphLinksModel.html#getGroupKeyForNodeData">getGroupKeyForNodeData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>nodedata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a node, group, or non-link.</p>
</div></li><li><h5>key: <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h5><div class="tsd-comment tsd-typography">
<p>This may be undefined if there should be no containing group data.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="setKeyForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> set<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<a href="#setKeyForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">set<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, key<span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
<div><p>If this is called when <a href="GraphLinksModel.html#linkKeyProperty">linkKeyProperty</a> is the empty string (i.e. its default value),
...
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkKeyProperty">linkKeyProperty</a>, <a href="GraphLinksModel.html#getKeyForLinkData">getKeyForLinkData</a></p>
</dd><dt class="">since</dt><dd><p>1.6</p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link</p>
</div></li><li><h5>key: <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h5></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="setLabelKeysForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> set<wbr/>Label<wbr/>Keys<wbr/>For<wbr/>Link<wbr/>Data<a href="#setLabelKeysForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">set<wbr/>Label<wbr/>Keys<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, arr<span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Replaces an Array of node key values that identify node data acting as labels on the given link data.</p>
<div><p>This method only works if <a href="GraphLinksModel.html#linkLabelKeysProperty">linkLabelKeysProperty</a> has been set to something other than an empty string.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkLabelKeysProperty">linkLabelKeysProperty</a>, <a href="GraphLinksModel.html#getLabelKeysForLinkData">getLabelKeysForLinkData</a>, <a href="GraphLinksModel.html#addLabelKeyForLinkData">addLabelKeyForLinkData</a>, <a href="GraphLinksModel.html#removeLabelKeyForLinkData">removeLabelKeyForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li><li><h5>arr: <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">[]</span></h5><div class="tsd-comment tsd-typography">
<p>an Array of node keys; an empty Array if the property was not present.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="setToKeyForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> set<wbr/>To<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<a href="#setToKeyForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">set<wbr/>To<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, key<span class="tsd-signature-symbol">: </span><a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Change the node key that the given link data references as the
destination of the link.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkToKeyProperty">linkToKeyProperty</a>, <a href="GraphLinksModel.html#getToKeyForLinkData">getToKeyForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li><li><h5>key: <a href="../index.html#Key" class="tsd-signature-type" data-tsd-kind="Type alias">Key</a></h5><div class="tsd-comment tsd-typography">
<p>This may be undefined if
the link should no longer go to any node.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="setToPortIdForLinkData" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> set<wbr/>To<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data<a href="#setToPortIdForLinkData" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">set<wbr/>To<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data<span class="tsd-signature-symbol">(</span>linkdata<span class="tsd-signature-symbol">: </span><a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a>, portname<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Change the information that the given link data uses to identify the
particular &quot;port&quot; that the link is going to.</p>
<dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="GraphLinksModel.html#linkToPortIdProperty">linkToPortIdProperty</a>, <a href="GraphLinksModel.html#getToPortIdForLinkData">getToPortIdForLinkData</a></p>
</dd></dl></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>linkdata: <a href="ObjectData.html" class="tsd-signature-type" data-tsd-kind="Interface">ObjectData</a></h5><div class="tsd-comment tsd-typography">
<p>a JavaScript object represented by a link.</p>
</div></li><li><h5>portname: <span class="tsd-signature-type">string</span></h5><div class="tsd-comment tsd-typography">
<p>This may be the empty string if
the link should no longer be associated with any particular &quot;port&quot;.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class"><a href="GraphLinksModel.html" class="tsd-kind-icon">Graph<wbr/>Links<wbr/>Model</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite"><a href="GraphLinksModel.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#archetypeNodeData" class="tsd-kind-icon">archetype<wbr/>Node<wbr/>Data</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#copyLinkDataFunction" class="tsd-kind-icon">copy<wbr/>Link<wbr/>Data<wbr/>Function</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#linkCategoryProperty" class="tsd-kind-icon">link<wbr/>Category<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#linkDataArray" class="tsd-kind-icon">link<wbr/>Data<wbr/>Array</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#linkFromKeyProperty" class="tsd-kind-icon">link<wbr/>From<wbr/>Key<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#linkFromPortIdProperty" class="tsd-kind-icon">link<wbr/>From<wbr/>Port<wbr/>Id<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#linkKeyProperty" class="tsd-kind-icon">link<wbr/>Key<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#linkLabelKeysProperty" class="tsd-kind-icon">link<wbr/>Label<wbr/>Keys<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#linkToKeyProperty" class="tsd-kind-icon">link<wbr/>To<wbr/>Key<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#linkToPortIdProperty" class="tsd-kind-icon">link<wbr/>To<wbr/>Port<wbr/>Id<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#makeUniqueLinkKeyFunction" class="tsd-kind-icon">make<wbr/>Unique<wbr/>Link<wbr/>Key<wbr/>Function</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#nodeGroupKeyProperty" class="tsd-kind-icon">node<wbr/>Group<wbr/>Key<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="GraphLinksModel.html#nodeIsGroupProperty" class="tsd-kind-icon">node<wbr/>Is<wbr/>Group<wbr/>Property</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#addLabelKeyForLinkData" class="tsd-kind-icon">add<wbr/>Label<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#addLinkData" class="tsd-kind-icon">add<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#addLinkDataCollection" class="tsd-kind-icon">add<wbr/>Link<wbr/>Data<wbr/>Collection</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#containsLinkData" class="tsd-kind-icon">contains<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#copyLinkData" class="tsd-kind-icon">copy<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="GraphLinksModel.html#copyNodeData" class="tsd-kind-icon">copy<wbr/>Node<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#findLinkDataForKey" class="tsd-kind-icon">find<wbr/>Link<wbr/>Data<wbr/>For<wbr/>Key</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#getCategoryForLinkData" class="tsd-kind-icon">get<wbr/>Category<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#getFromKeyForLinkData" class="tsd-kind-icon">get<wbr/>From<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#getFromPortIdForLinkData" class="tsd-kind-icon">get<wbr/>From<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#getGroupKeyForNodeData" class="tsd-kind-icon">get<wbr/>Group<wbr/>Key<wbr/>For<wbr/>Node<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#getKeyForLinkData" class="tsd-kind-icon">get<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#getLabelKeysForLinkData" class="tsd-kind-icon">get<wbr/>Label<wbr/>Keys<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#getToKeyForLinkData" class="tsd-kind-icon">get<wbr/>To<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#getToPortIdForLinkData" class="tsd-kind-icon">get<wbr/>To<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#isGroupForNodeData" class="tsd-kind-icon">is<wbr/>Group<wbr/>For<wbr/>Node<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#makeLinkDataKeyUnique" class="tsd-kind-icon">make<wbr/>Link<wbr/>Data<wbr/>Key<wbr/>Unique</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#mergeLinkDataArray" class="tsd-kind-icon">merge<wbr/>Link<wbr/>Data<wbr/>Array</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#removeLabelKeyForLinkData" class="tsd-kind-icon">remove<wbr/>Label<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#removeLinkData" class="tsd-kind-icon">remove<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#removeLinkDataCollection" class="tsd-kind-icon">remove<wbr/>Link<wbr/>Data<wbr/>Collection</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#setCategoryForLinkData" class="tsd-kind-icon">set<wbr/>Category<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="GraphLinksModel.html#setDataProperty" class="tsd-kind-icon">set<wbr/>Data<wbr/>Property</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#setFromKeyForLinkData" class="tsd-kind-icon">set<wbr/>From<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#setFromPortIdForLinkData" class="tsd-kind-icon">set<wbr/>From<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#setGroupKeyForNodeData" class="tsd-kind-icon">set<wbr/>Group<wbr/>Key<wbr/>For<wbr/>Node<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#setKeyForLinkData" class="tsd-kind-icon">set<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#setLabelKeysForLinkData" class="tsd-kind-icon">set<wbr/>Label<wbr/>Keys<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#setToKeyForLinkData" class="tsd-kind-icon">set<wbr/>To<wbr/>Key<wbr/>For<wbr/>Link<wbr/>Data</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="GraphLinksModel.html#setToPortIdForLinkData" class="tsd-kind-icon">set<wbr/>To<wbr/>Port<wbr/>Id<wbr/>For<wbr/>Link<wbr/>Data</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
