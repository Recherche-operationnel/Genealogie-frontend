...
<p>This tool can run when the diagram is not read-only and supports creating new nodes,
and when there has been a click (or double-click if <a href="ClickCreatingTool.html#isDoubleClick">isDoubleClick</a> is true)
in the background of the diagram (not on a <a href="Part.html">Part</a>),
and <a href="ClickCreatingTool.html#archetypeNodeData">archetypeNodeData</a> is an object that can be copied and added to the model.</p>
...
<p>Upon a click, call <a href="ClickCreatingTool.html#insertPart">insertPart</a> and stop this tool.</p>
</div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="insertPart" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span class="tsd-flag ts-flagVirtual">Virtual</span>  insert<wbr/>Part<a href="#insertPart" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">insert<wbr/>Part<span class="tsd-signature-symbol">(</span>loc<span class="tsd-signature-symbol">: </span><a href="Point.html" class="tsd-signature-type" data-tsd-kind="Class">Point</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="Part.html" class="tsd-signature-type" data-tsd-kind="Class">Part</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Create a node by adding a copy of the <a href="ClickCreatingTool.html#archetypeNodeData">archetypeNodeData</a> object
to the diagram&#39;s model, assign its <a href="Part.html#location">Part.location</a>
to be the given point, and select the new part.</p>
<div><p>This starts and commits a transaction and also raises the &quot;PartCreated&quot; <a href="DiagramEvent.html">DiagramEvent</a>.
The actual part that is added to the diagram may be a <a href="Part.html">Part</a>, a <a href="Node.html">Node</a>,
or even a <a href="Group.html">Group</a>, depending on the properties of the <a href="ClickCreatingTool.html#archetypeNodeData">archetypeNodeData</a>
and the type of the template that is copied to create the part.</p>
<p>This method also raises the &quot;ChangingSelection&quot; and &quot;ChangedSelection&quot; diagram events outside the transaction.</p>
<p>This method may be overridden, although it is usually much easier to just set <a href="ClickCreatingTool.html#archetypeNodeData">archetypeNodeData</a>.
Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</p>
</div></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>loc: <a href="Point.html" class="tsd-signature-type" data-tsd-kind="Class">Point</a></h5><div class="tsd-comment tsd-typography">
<p>a Point in document coordinates.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="Part.html" class="tsd-signature-type" data-tsd-kind="Class">Part</a></h4><div><p>the newly created Part, or null if it failed.</p>
</div></li></ul></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class"><a href="ClickCreatingTool.html" class="tsd-kind-icon">Click<wbr/>Creating<wbr/>Tool</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite"><a href="ClickCreatingTool.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="ClickCreatingTool.html#archetypeNodeData" class="tsd-kind-icon">archetype<wbr/>Node<wbr/>Data</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="ClickCreatingTool.html#isDoubleClick" class="tsd-kind-icon">is<wbr/>Double<wbr/>Click</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="ClickCreatingTool.html#isGridSnapEnabled" class="tsd-kind-icon">is<wbr/>Grid<wbr/>Snap<wbr/>Enabled</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="ClickCreatingTool.html#canStart" class="tsd-kind-icon">can<wbr/>Start</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="ClickCreatingTool.html#doMouseUp" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Up</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="ClickCreatingTool.html#insertPart" class="tsd-kind-icon">insert<wbr/>Part</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
