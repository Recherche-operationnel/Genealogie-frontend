...
as determined by <a href="LinkLabelOnPathDraggingTool.html#findLabel">findLabel</a>.</p>
...
<p>Start a transaction, call findLabel and remember it as the &quot;label&quot; property,
and remember the original values for the label&#39;s segment properties.</p>
...
<p>Restore the label&#39;s original value for GraphObject.segment... properties.</p>
...
<p>During the drag, call <a href="LinkLabelOnPathDraggingTool.html#updateSegmentOffset">updateSegmentOffset</a> in order to set the segment... properties of the label.</p>
...
<p>At the end of the drag, update the segment properties of the label and finish the tool,
...
an object that has the &quot;_isLinkLabel&quot; property set to true and that is an immediate child of a Link Panel.</p>
