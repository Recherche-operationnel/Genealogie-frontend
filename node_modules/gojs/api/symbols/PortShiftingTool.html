...
as determined by <a href="PortShiftingTool.html#findPort">findPort</a>.</p>
...
<p>Start a transaction, call <a href="PortShiftingTool.html#findPort">findPort</a> and remember it as the &quot;port&quot; property,
and remember the original value for the port&#39;s <a href="GraphObject.html#alignment">GraphObject.alignment</a> property.</p>
...
<p>Restore the port&#39;s original value for GraphObject.alignment.</p>
...
<p>During the drag, call <a href="PortShiftingTool.html#updateAlignment">updateAlignment</a> in order to set the <a href="GraphObject.html#alignment">GraphObject.alignment</a> of the port.</p>
...
<p>At the end of the drag, update the alignment of the port and finish the tool,
...
<p>Clear any reference to a port element.</p>
</div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="findPort" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> find<wbr/>Port<a href="#findPort" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">find<wbr/>Port<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="GraphObject.html" class="tsd-signature-type" data-tsd-kind="Class">GraphObject</a></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>From the <a href="GraphObject.html">GraphObject</a> at the mouse point, search up the visual tree until we get to
an object that has the <a href="GraphObject.html#portId">GraphObject.portId</a> property set to a non-empty string, that is in a Spot Panel,
and that is not the main element of the panel (typically the first element).</p>
</div><h4 class="tsd-returns-title">Returns <a href="GraphObject.html" class="tsd-signature-type" data-tsd-kind="Class">GraphObject</a></h4><div><p>This returns null if no such port is at the mouse down point.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="updateAlignment" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> update<wbr/>Alignment<a href="#updateAlignment" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">update<wbr/>Alignment<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Save the port&#39;s <a href="GraphObject.html#alignment">GraphObject.alignment</a> as a fractional Spot in the Spot Panel
...
This does not modify the port&#39;s <a href="GraphObject.html#alignmentFocus">GraphObject.alignmentFocus</a> property.</p>
</div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class tsd-is-extension"><a href="PortShiftingTool.html" class="tsd-kind-icon">Port<wbr/>Shifting<wbr/>Tool</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite"><a href="PortShiftingTool.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-property tsd-parent-kind-class"><a href="PortShiftingTool.html#port" class="tsd-kind-icon">port</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PortShiftingTool.html#canStart" class="tsd-kind-icon">can<wbr/>Start</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PortShiftingTool.html#doActivate" class="tsd-kind-icon">do<wbr/>Activate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PortShiftingTool.html#doCancel" class="tsd-kind-icon">do<wbr/>Cancel</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PortShiftingTool.html#doDeactivate" class="tsd-kind-icon">do<wbr/>Deactivate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PortShiftingTool.html#doMouseMove" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Move</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PortShiftingTool.html#doMouseUp" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Up</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="PortShiftingTool.html#doStop" class="tsd-kind-icon">do<wbr/>Stop</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="PortShiftingTool.html#findPort" class="tsd-kind-icon">find<wbr/>Port</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="PortShiftingTool.html#updateAlignment" class="tsd-kind-icon">update<wbr/>Alignment</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
