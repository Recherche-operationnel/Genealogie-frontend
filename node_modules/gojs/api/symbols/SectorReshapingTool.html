...
<p>This tool can only start if Diagram.allowReshape is true and the mouse-down event
is at a tool handle created by this tool.</p>
...
<p>Remember the original angles and radius and start a transaction.</p>
...
<p>Restore the original angles and radius and then stop this tool.</p>
...
<p>Depending on the current handle being dragged, update the &quot;radius&quot;, the &quot;angle&quot;, or the &quot;sweep&quot;
properties on the model data.
Those property names are currently parameterized as static members of SectorReshapingTool.</p>
...
<p>Finish the transaction and stop the tool.</p>
...
<p>If the Part is selected, show two angle-changing tool handles and one radius-changing tool handle.</p>
</div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>part: <a href="Part.html" class="tsd-signature-type" data-tsd-kind="Class">Part</a></h5></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class tsd-is-extension"><a href="SectorReshapingTool.html" class="tsd-kind-icon">Sector<wbr/>Reshaping<wbr/>Tool</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite"><a href="SectorReshapingTool.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="SectorReshapingTool.html#angleProperty" class="tsd-kind-icon">angle<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="SectorReshapingTool.html#radiusProperty" class="tsd-kind-icon">radius<wbr/>Property</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="SectorReshapingTool.html#sweepProperty" class="tsd-kind-icon">sweep<wbr/>Property</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="SectorReshapingTool.html#canStart" class="tsd-kind-icon">can<wbr/>Start</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="SectorReshapingTool.html#doActivate" class="tsd-kind-icon">do<wbr/>Activate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="SectorReshapingTool.html#doCancel" class="tsd-kind-icon">do<wbr/>Cancel</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="SectorReshapingTool.html#doDeactivate" class="tsd-kind-icon">do<wbr/>Deactivate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="SectorReshapingTool.html#doMouseMove" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Move</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="SectorReshapingTool.html#doMouseUp" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Up</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="SectorReshapingTool.html#updateAdornments" class="tsd-kind-icon">update<wbr/>Adornments</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
