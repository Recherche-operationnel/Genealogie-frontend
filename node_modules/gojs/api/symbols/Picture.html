...
and setting the Picture&#39;s <a href="GraphObject.html#desiredSize">GraphObject.desiredSize</a>.</p>
<p>With some images (notably sprite sheets) only a portion of the image is expected to be drawn.
The <a href="Picture.html#sourceRect">sourceRect</a> property allows the programmer to specify a rectangular area of
the source image that the Picture should display.</p>
<p>The <a href="Picture.html#imageStretch">imageStretch</a> property allows an image to be resized inside of its bounding box.
...
</div></div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5><span class="tsd-flag ts-flagOptional">Optional</span> source: <span class="tsd-signature-type">string</span></h5><div class="tsd-comment tsd-typography">
<p>Optionally set the Pictures&#39;s <a href="Picture.html#source">source</a>.</p>
</div></li><li><h5><span class="tsd-flag ts-flagOptional">Optional</span> init: <span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><a href="Picture.html" class="tsd-signature-type" data-tsd-kind="Class">Picture</a><span class="tsd-signature-symbol">&gt;</span></h5><div class="tsd-comment tsd-typography">
<p>Optional properties to initialize.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="Picture.html" class="tsd-signature-type" data-tsd-kind="Class">Picture</a></h4></li><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>The constructor creates a Picture that shows nothing until the
<a href="Picture.html#source">source</a> or <a href="Picture.html#element">element</a> is specified. It is also common to specify the
<a href="GraphObject.html#desiredSize">GraphObject.desiredSize</a> to make sure that the picture&#39;s size is known
before the image is loaded asynchronously, so that layouts do not need to be recomputed.</p>
</div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5><span class="tsd-flag ts-flagOptional">Optional</span> init: <span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><a href="Picture.html" class="tsd-signature-type" data-tsd-kind="Class">Picture</a><span class="tsd-signature-symbol">&gt;</span></h5><div class="tsd-comment tsd-typography">
<p>Optional properties to initialize.</p>
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="Picture.html" class="tsd-signature-type" data-tsd-kind="Class">Picture</a></h4></li></ul></section></section><section class="tsd-panel-group tsd-member-group "><h2>Properties</h2><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="element" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> element<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">HTMLCanvasElement</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">HTMLImageElement</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">HTMLVideoElement</span><a href="#element" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the Picture&#39;s HTML element that provides some kind of visual image.</p>
...
Setting this does not set the <a href="Picture.html#source">Picture.source</a> attribute and that attribute may be unknowable.</p>
...
You must call <a href="Picture.html#redraw">redraw</a> after the image is finished loading if you wish for the Diagram to be updated immediately.</p>
</div></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="errorFunction" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> error<wbr/>Function<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="Picture.html" class="tsd-signature-type" data-tsd-kind="Class">Picture</a>, b<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Event</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span><a href="#errorFunction" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the function to call if an image set by <a href="Picture.html#source">source</a> fails to load.
The arguments to this function are this Picture and the HTMLImageElement&#39;s &quot;error&quot; Event.</p>
<div><p>This is called once per Picture, for every Picture that is using the same <a href="Picture.html#source">source</a> that failed to load.
This will never be called if the <a href="Picture.html#source">source</a> is never set, and is not called with Pictures that use <a href="Picture.html#element">element</a> instead.</p>
<p>The default value is null, meaning that no specific action occurs when there is an error loading an image.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="Picture.html#successFunction">successFunction</a></p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="flip" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> flip<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">EnumValue</span><a href="#flip" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets how the Picture is displayed: Either normally or with a Horizontal or Vertical flip or both.</p>
...
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="imageAlignment" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> image<wbr/>Alignment<span class="tsd-signature-symbol">: </span><a href="Spot.html" class="tsd-signature-type" data-tsd-kind="Class">Spot</a><a href="#imageAlignment" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
...
the <a href="Picture.html#imageStretch">imageStretch</a> property value is not go.GraphObject.Fill.</p>
<div><p>This does not affect Picture coordinates or bounds, it only affects what is drawn within the given area.
The default value is <a href="Spot.html#static-Center">Spot.Center</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="Picture.html#imageStretch">imageStretch</a></p>
</dd><dt class="">since</dt><dd><p>1.7</p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="imageStretch" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> image<wbr/>Stretch<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">EnumValue</span><a href="#imageStretch" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets how the Picture&#39;s image is stretched within its bounding box.
Some images will be a different aspect ratio than their given size or <a href="GraphObject.html#desiredSize">desiredSize</a>.
This property will never change the size of the Picture itself,
only the size of the image that is drawn in the Picture&#39;s <a href="GraphObject.html#actualBounds">actualBounds</a>.</p>
<div><p>Possible values are <a href="GraphObject.html#static-Fill">GraphObject.Fill</a>, <a href="GraphObject.html#static-Uniform">GraphObject.Uniform</a>,
<a href="GraphObject.html#static-UniformToFill">GraphObject.UniformToFill</a>, and <a href="GraphObject.html#static-None">GraphObject.None</a>.
The default is <a href="GraphObject.html#static-Fill">GraphObject.Fill</a>.</p>
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="Picture.html#imageAlignment">imageAlignment</a></p>
...
<p>This read-only property returns the natural size of this picture as determined by its source&#39;s width and height.
The value is initially NaN x NaN until the picture has been measured.
It will use the <a href="Picture.html#element">element</a>&#39;s <code>naturalWidth</code> and <code>naturalHeight</code> if available.</p>
</div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="source" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> source<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><a href="#source" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the Picture&#39;s source URL, which can be any valid image (png, jpg, gif, etc) URL.</p>
<div><p>The default value is the empty string, which specifies no image source.
Setting this attribute creates an HTMLImageElement and sets the <a href="Picture.html#element">Picture.element</a>
attribute to that element. When the element loads, this Picture may remeasure if no <a href="GraphObject.html#desiredSize">GraphObject.desiredSize</a> was set,
and Diagrams using the picture will redraw.</p>
<p>To avoid remeasuring and rearranging Parts as images load asynchronously,
be sure to set the <a href="GraphObject.html#desiredSize">GraphObject.desiredSize</a>
(or <a href="GraphObject.html#width">GraphObject.width</a> and <a href="GraphObject.html#height">GraphObject.height</a>) to fixed values.</p>
<p>Setting the source of multiple Pictures to the same URL will cause only one HTMLImageElement
to be created and shared. Setting the source to the empty string will set <a href="Picture.html#element">Picture.element</a> to null.
...
</div></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="sourceCrossOrigin" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> source<wbr/>Cross<wbr/>Origin<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="Picture.html" class="tsd-signature-type" data-tsd-kind="Class">Picture</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">string</span><a href="#sourceCrossOrigin" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets a function that returns a value for image.crossOrigin.</p>
<div><p>The default value is null, which will not set a value for image.crossOrigin.
...
Example:</p>
<pre><code class="language-js"><span class="hl-2">   </span><span class="hl-5">$</span><span class="hl-2">(</span><span class="hl-4">go</span><span class="hl-2">.</span><span class="hl-4">Picture</span><span class="hl-2">,</span><br/><span class="hl-2">     { </span><span class="hl-4">width:</span><span class="hl-2"> </span><span class="hl-7">64</span><span class="hl-2">, </span><span class="hl-4">height:</span><span class="hl-2"> </span><span class="hl-7">64</span><span class="hl-2"> },</span><br/><span class="hl-2">     { </span><span class="hl-5">sourceCrossOrigin</span><span class="hl-4">:</span><span class="hl-2"> </span><span class="hl-4">pict</span><span class="hl-2"> </span><span class="hl-1">=&gt;</span><span class="hl-2"> </span><span class="hl-6">&quot;use-credentials&quot;</span><span class="hl-2"> },</span><br/><span class="hl-2">     </span><span class="hl-1">new</span><span class="hl-2"> </span><span class="hl-4">go</span><span class="hl-2">.</span><span class="hl-5">Binding</span><span class="hl-2">(</span><span class="hl-6">&quot;source&quot;</span><span class="hl-2">, </span><span class="hl-6">&quot;path&quot;</span><span class="hl-2">))</span>
</code></pre>
</div><dl class="tsd-comment-tags"><dt class="">since</dt><dd><p>1.5</p>
</dd></dl></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="sourceRect" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> source<wbr/>Rect<span class="tsd-signature-symbol">: </span><a href="Rect.html" class="tsd-signature-type" data-tsd-kind="Class">Rect</a><a href="#sourceRect" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the rectangular area of the source image that this picture should display.
This is only common with sprite maps and image tables.</p>
<div><p>The value must be of type <a href="Rect.html">Rect</a>.
The default value is Rect(NaN, NaN, NaN, NaN), which means the whole source image should be used.</p>
</div></div></li></ul></section><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="successFunction" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> success<wbr/>Function<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="Picture.html" class="tsd-signature-type" data-tsd-kind="Class">Picture</a>, b<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Event</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span><a href="#successFunction" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets the function to call when an image set by <a href="Picture.html#source">source</a> loads successfully.
The arguments to this function are this Picture and the HTMLImageElement&#39;s &quot;load&quot; Event.</p>
<div><p>This is called once per Picture, for every Picture that is using the same <a href="Picture.html#source">source</a> that loaded successfully.
This will never be called if the <a href="Picture.html#source">source</a> is never set, and is not called with Pictures that use <a href="Picture.html#element">element</a> instead.
...
</div><dl class="tsd-comment-tags"><dt class="">see</dt><dd><p><a href="Picture.html#errorFunction">errorFunction</a></p>
</dd><dt class="">since</dt><dd><p>1.7</p>
</dd></dl></div></li></ul></section></section><section class="tsd-panel-group tsd-member-group "><h2>Methods</h2><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="redraw" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> redraw<a href="#redraw" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">redraw<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Redraws a Picture, which can be useful if the backing <a href="Picture.html#element">element</a> is an HTML Canvas or HTML Video that has changed.
This will not attempt to <em>reload</em> any image. If you need to do that, call <a href="Picture.html#reloadSource">reloadSource</a>.</p>
<div><p>This does not need to be called within a transaction, and will not re-measure anything.</p>
</div><dl class="tsd-comment-tags"><dt class="">since</dt><dd><p>2.1</p>
</dd></dl></div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section><section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class"><a id="reloadSource" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> reload<wbr/>Source<a href="#reloadSource" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class"><li class="tsd-signature tsd-kind-icon">reload<wbr/>Source<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li></ul><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Attempts to reload a <a href="Picture.html#source">Picture.source</a> image. This can be useful if the content on a server has changed, or was missing before.
If a new image is loaded, this Picture may remeasure and/or redraw.</p>
<div><p>Because of browsers caching assets, you may additionally need to force a re-fetch of the Picture&#39;s source URL
...
</dd></dl></div><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class"><a href="Picture.html" class="tsd-kind-icon">Picture</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite"><a href="Picture.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#element" class="tsd-kind-icon">element</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#errorFunction" class="tsd-kind-icon">error<wbr/>Function</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#flip" class="tsd-kind-icon">flip</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#imageAlignment" class="tsd-kind-icon">image<wbr/>Alignment</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#imageStretch" class="tsd-kind-icon">image<wbr/>Stretch</a></li><li class="tsd-kind-get-signature tsd-parent-kind-class tsd-is-overwrite"><a href="Picture.html#naturalBounds" class="tsd-kind-icon">natural<wbr/>Bounds</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#source" class="tsd-kind-icon">source</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#sourceCrossOrigin" class="tsd-kind-icon">source<wbr/>Cross<wbr/>Origin</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#sourceRect" class="tsd-kind-icon">source<wbr/>Rect</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="Picture.html#successFunction" class="tsd-kind-icon">success<wbr/>Function</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="Picture.html#redraw" class="tsd-kind-icon">redraw</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="Picture.html#reloadSource" class="tsd-kind-icon">reload<wbr/>Source</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
