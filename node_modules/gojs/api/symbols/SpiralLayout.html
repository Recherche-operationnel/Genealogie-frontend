...
</div></li></ul><h4 class="tsd-returns-title">Returns <a href="SpiralLayout.html" class="tsd-signature-type" data-tsd-kind="Class">SpiralLayout</a></h4></li></ul></section></section><section class="tsd-panel-group tsd-member-group "><h2>Properties</h2><section class="tsd-panel tsd-member tsd-kind-accessor tsd-parent-kind-class"><a id="clockwise" class="tsd-anchor"></a><h3 class="tsd-anchor-link"> clockwise<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><a href="#clockwise" aria-label="Permalink" class="tsd-anchor-icon"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></svg></a></h3><ul class="tsd-descriptions"><li class="tsd-description"><div class="tsd-comment tsd-typography">
<p>Gets or sets whether the spiral should go clockwise or counter-clockwise.</p>
...
<p>Gets or sets the radius distance.</p>
<div><p>The default value is NaN.</p>
...
This respects the <a href="SpiralLayout.html#spacing">spacing</a> property to affect the layout.</p>
