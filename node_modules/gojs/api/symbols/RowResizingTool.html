...
This will be contained by an <a href="Adornment.html">Adornment</a> whose category is &quot;RowResizing&quot;.
Its <a href="Adornment.html#adornedObject">Adornment.adornedObject</a> is the same as the <a href="RowResizingTool.html#adornedTable">adornedTable</a>.</p>
...
<p>Gets or sets small GraphObject that is copied as a resize handle for each row.
...
<p>This tool may run when there is a mouse-down event on a &quot;RowResizing&quot; handle,
...
<p>Find the <a href="RowResizingTool.html#handle">handle</a>, ensure type <a href="Panel.html#static-Table">Panel.Table</a>, capture the mouse, and start a transaction.</p>
<div><p>If the call to <a href="Tool.html#findToolHandleAt">Tool.findToolHandleAt</a> finds no &quot;RowResizing&quot; tool handle, this method returns without activating this tool.</p>
...
<p>Call <a href="RowResizingTool.html#resize">resize</a> with a new size determined by the current mouse point.
This determines the new bounds by calling <a href="RowResizingTool.html#computeResize">computeResize</a>.</p>
...
<p>Call <a href="RowResizingTool.html#resize">resize</a> with the final bounds based on the most recent mouse point, and commit the transaction.
This determines the new bounds by calling <a href="RowResizingTool.html#computeResize">computeResize</a>.</p>
...
<p>Change the <a href="RowColumnDefinition.html#height">RowColumnDefinition.height</a> of the row being resized
...
<p>the value returned by the call to <a href="RowResizingTool.html#computeResize">computeResize</a></p>
...
<p>Show an <a href="Adornment.html">Adornment</a> with a resize handle at each row.
Don&#39;t show anything if <a href="RowResizingTool.html#tableName">tableName</a> doesn&#39;t identify a <a href="Panel.html">Panel</a>
that has a <a href="Panel.html#type">Panel.type</a> of type <a href="Panel.html#static-Table">Panel.Table</a>.</p>
</div><h4 class="tsd-parameters-title">Parameters</h4><ul class="tsd-parameters"><li><h5>part: <a href="Part.html" class="tsd-signature-type" data-tsd-kind="Class">Part</a></h5></li></ul><h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4></li></ul></section></section></div><div class="col-4 col-menu menu-sticky-wrap menu-highlight"><nav class="tsd-navigation primary"><ul><li class=""><a href="../index.html">GoJS Class Index</a></li></ul></nav><nav class="tsd-navigation secondary menu-sticky"><ul><li class="current tsd-kind-class tsd-is-extension"><a href="RowResizingTool.html" class="tsd-kind-icon">Row<wbr/>Resizing<wbr/>Tool</a><ul><li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite"><a href="RowResizingTool.html#constructor" class="tsd-kind-icon">constructor</a></li><li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="RowResizingTool.html#adornedTable" class="tsd-kind-icon">adorned<wbr/>Table</a></li><li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="RowResizingTool.html#handle" class="tsd-kind-icon">handle</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="RowResizingTool.html#handleArchetype" class="tsd-kind-icon">handle<wbr/>Archetype</a></li><li class="tsd-kind-accessor tsd-parent-kind-class"><a href="RowResizingTool.html#tableName" class="tsd-kind-icon">table<wbr/>Name</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RowResizingTool.html#canStart" class="tsd-kind-icon">can<wbr/>Start</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="RowResizingTool.html#computeResize" class="tsd-kind-icon">compute<wbr/>Resize</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RowResizingTool.html#doActivate" class="tsd-kind-icon">do<wbr/>Activate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RowResizingTool.html#doDeactivate" class="tsd-kind-icon">do<wbr/>Deactivate</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RowResizingTool.html#doKeyDown" class="tsd-kind-icon">do<wbr/>Key<wbr/>Down</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RowResizingTool.html#doMouseMove" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Move</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RowResizingTool.html#doMouseUp" class="tsd-kind-icon">do<wbr/>Mouse<wbr/>Up</a></li><li class="tsd-kind-method tsd-parent-kind-class"><a href="RowResizingTool.html#resize" class="tsd-kind-icon">resize</a></li><li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite"><a href="RowResizingTool.html#updateAdornments" class="tsd-kind-icon">update<wbr/>Adornments</a></li></ul></li></ul></nav></div></div></div><div class="tsd w-full max-w-screen-xl mx-auto px-2"><div class="bottom-copyright">Copyright © 1998-2022 by Northwoods Software Corporation.</div></div><footer class=""><div class="tsd w-full max-w-screen-xl mx-auto px-2"><h2>Settings</h2><p class="mb-4">Theme <select id="theme"><option value="os">OS</option><option value="light">Light</option><option value="dark">Dark</option></select></p></div></footer><div class="overlay"></div><script src="../assets/main.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-1506307-5"></script>
      <script>
